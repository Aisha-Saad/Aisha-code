        ...
        <section id='contact' className='section'>
            <div className="container lg:grid  lg:grid-cols-2 lg:items-stretch">
                <div className=" mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:min-w-[12ch]">
                        Contact me for collaboration

                    </h2>
                    <p className=' text-zinc-400 mt-3 mb-8 max-w-[30ch]'>Reach out today to discuss your project needs and start collaborating on something amazing!
                    </p>
                    ...
                    <div className=" flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            ...
                            <a
                                ...
                                target='_blank'
                                className='w-12 h-12 grid place-items-center ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] 
                ...
                <form action="https://getform.io/f/bolodvoa" method='POST' className='xl:pl-10 2xl:pl-20'>
                    <div className=" md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className=" mb-4  ">
                            <label htmlFor="name" className='lable'>Name</label>
                            <input type="text" name="name" id="name" autoComplete='name' required placeholder='Aisha Code' className='text-field' />
                        </div>

                        <div className="mb-4 ">
                            <label htmlFor="email" className='lable'>Email</label>
                            <input type="email" name="email" id="email" autoComplete='email' required placeholder='Aisha.al.ahmaddi@gmail.com' className='text-field' />
                        </div>
                       
                        
                    </div>
                     <div className="mb-4 ">
                            <label htmlFor="message" className='lable'>
                                message
                            </label>

                            <textarea name="message" id="message" placeholder=' Hi!' required className='text-field resize-y min-h-32 max-h-80 w-full'></textarea>
                        </div>
